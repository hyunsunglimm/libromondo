  ...
  return (
    <section className="mt-8 md:mt-4">
      <div className="flex border border-black rounded-md">
        <button
          className={`text-2xl md:text-base w-full p-2 border-r border-black ${type === "book" && "bg-black text-white"}`}
          onClick={() => setType("book")}
        >
          서재
        </button>
        <button
          className={`text-2xl md:text-base w-full p-2 ${type === "review" && "bg-black text-white"}`}
